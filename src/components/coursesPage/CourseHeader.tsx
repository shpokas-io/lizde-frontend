...
export default function CourseHeader({
  ...
  return (
    <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl overflow-hidden border border-gray-200">
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-col lg:flex-row items-center gap-10">
          <div className="lg:w-1/2 relative">
            <div className="absolute -top-2 -left-2 w-20 h-20 bg-orange-500 rounded-full opacity-20 blur-xl"></div>
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-orange-600 rounded-full opacity-20 blur-xl"></div>
            <Image
              src={imageUrl}
              alt={title}
              width={600}
